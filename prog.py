...
def play(word):
    ...
    gues = False                    # сигнальная метка
    count = int(len(word_completion))  # количество букв в загаданном слове
    guessed_letters = []               # список уже названных букв
    guessed_words = []                 # список уже названных слов
    tries = 6  

    print('Привет, давай сыграем в cловестную угадайку!')
    print(display_hangman(tries))
    print('Начальное слово', word_completion)

    while not gues and tries > 0:
        gue = input(f'Введите букву, или cлово. Загаданное слово состоит из {count} букв: ').upper()
        if not gue.isalpha():
            print(f"Неверный ввод. Введите букву, или cлово. Загаданное слово состоит из {count} букв: ")
        if len(gue) == len(word) and gue.isalpha():
            if gue in guessed_words:
                print('Такое слово, вы уже вводили!')
                continue 
            elif gue != word:
                print('Неверное слово!')
                guessed_words.append(gue)
                tries -= 1
                print(display_hangman(tries))
            ...
            if gue in guessed_letters:
                print('Такую букву, ты уже вводил!')
            elif  gue not in word:
                print('Неверный выбор.')
                guessed_letters.append(gue)
                tries -= 1
                print(display_hangman(tries))
                print(f'Попытка {tries}')
            else:
                print(f'Отличная работа! Данная буква {gue}, есть в загаданном слове')
                guessed_letters.append(gue)
            ...
            print(f'Введёное количество букв, не соотвествует количеству букв в загаданном слове, введите либо букву либо слово состоящее из {count} букв')
        
        print('\nТекущее состояние')
        print(f'Слово загаданное: {word_completion}')
        print(f'Использованные буквы:', ', '.join(guessed_letters))
        print(f'Использованные слова:', ', '.join(guessed_words))

    if gues:
        print('Поздравляю, вы угадали слова! ')
    else:
        print(f'Извините вы проиграли! Загаданное слово {word}')
